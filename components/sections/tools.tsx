...
export const AvailableTools = () => (
  <section id="available-tools" className="w-full max-w-4xl mx-auto my-32 px-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {/* JSON Formatter Card */}
      <Card className="relative bg-white border border-gray-200 rounded-xl transform transition-all duration-300 hover:scale-105 flex flex-col">
        <CardHeader className="text-center p-6 rounded-t-xl">
          <div className="relative">
            <FileJson className="w-12 h-12 text-blue-500 mx-auto" />
          </div>
        ...
        <CardFooter className="p-6 mt-auto">
          <a href="/app" className="w-full py-2.5 px-4 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-all font-medium">
            Try it now
          </a>
        </CardFooter>
      </Card>
      ...
      <Card className="relative bg-white border border-gray-200 rounded-xl transform transition-all duration-300 hover:scale-105 flex flex-col">
        ...
        <CardFooter className="p-6 mt-auto">
          <a href="/app" className="w-full py-2.5 px-4 bg-purple-500 text-white rounded-lg hover:bg-purple-600 transition-all font-medium">
            Try it now
          </a>
        </CardFooter>
      </Card>
      ...
      <Card className="relative bg-white border border-gray-200 rounded-xl transform transition-all duration-300 hover:scale-105 flex flex-col">
        ...
        <CardFooter className="p-6 mt-auto">
          <a href="/app" className="w-full py-2.5 px-4 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition-all font-medium">
            Try it now
          </a>
        </CardFooter>
      </Card>
